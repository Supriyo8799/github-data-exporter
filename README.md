...
A tool to export GitHub user's starred repositories, followers, following, repositories, and gists as CSV files in a ZIP archive.
...
> **Note**: This tool only lists the **starred repositories**, **followers**, **following**, **repositories**, and **gists** of a GitHub user. It does not include other data such as project details or code from repositories.

## How to Use

1. Enter your **GitHub username** and **GitHub Personal Access Token**.
2. Click **Get Data** to fetch the GitHub data (starred repositories, followers, following, repositories, and gists).
...
4. Click **Download CSV Files** to download a ZIP archive containing:
   - `github_stars_<username>.csv` (Starred repositories)
